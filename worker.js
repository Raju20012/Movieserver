...
const serviceaccounts = [
  ...
  const authConfig = {
      ...
      "refresh_token": "1//03XSaEbds0egvCgYIARAAGAMSNwF-L9IrhCufDUVioGChrgKj7_vLo1_i2m0p7zTa6uYBblppfQQFSg7-inPaY9hTYF4ADQVH7Mo", // Authorize token
      ...
      "roots":[
        {
            "id": "1RU8QMoC6ASslbwIyqG0rwMKEYxyxq8hB",
            "name": "Drive One GDT",
            "protect_file_link": false,
           // "auth": {"username":"password"} /* Remove double slash before "auth" to activate id password protection */
        },
        {
            "id": "1dJFB842dQD6d7Sa8GFtdJzz_d9dZGx-x",
            "name": "Drive Two Movie",
            "protect_file_link": false,
           // "auth": {"username":"password"} /* Remove double slash before "auth" to activate id password protection */
        },
      ]};
  ...
  const uiConfig = {
      ...
      "favicon": "https://cdn-icons-png.flaticon.com/512/189/189249.png",
      // if logo is true then link otherwise just text for name
      "logo_link_name": "https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/f082f536759891.572888607748a.jpg",
